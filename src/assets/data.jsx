...
const pricingData = [
  {
    ...
    price: '$29',
    description:
      'Perfect for beginner traders who want to explore the market with essential tools.',
    isPopular: false,
    features: [
  ...
  },
  {
    ...
    price: '$79',
    description:
      'Advanced tools and automation features for growing traders and professionals.',
    isPopular: true,
    features: [
  ...
  },
  {
    ...
    price: 'Custom',
    description:
      'Tailored solutions for trading firms and high-volume professional traders.',
    isPopular: false,
    features: [
